  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <span className="inline-block border border-white/10 rounded-full px-4 py-1.5 text-[10px] tracking-[0.15em] uppercase font-medium text-white/70 font-mono">
        ...
        <div className="flex items-center justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 bg-cyan-500 text-black px-6 py-3 rounded hover:bg-cyan-400 transition-colors text-sm font-semibold tracking-wider uppercase font-mono"
          >
            HIGHLIGHTS
          </a>
          <button
            className="inline-flex items-center gap-2 bg-transparent border border-white/20 text-white/80 px-6 py-3 rounded hover:border-white/40 hover:text-white transition-colors text-sm font-semibold tracking-wider uppercase font-mono"
          >
