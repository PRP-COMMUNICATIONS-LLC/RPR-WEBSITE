...
export const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[100] bg-black/80 backdrop-blur-md border-b border-white/10 h-20 flex items-center">
      <div className="max-w-7xl mx-auto px-6 w-full flex items-center justify-between">

        {/* 1. LOGO SUBSTRATE (v2.1.2: Inline SVG Master) */}
        ...
        {/* 2. DESKTOP NAV (Canonical 3-Item Sequence) */}
          ...
          >
            {user ? (
              user.photoURL ? (
                ...
                <div className="w-full h-full bg-cyan-900 flex items-center justify-center text-[10px] font-black text-cyan-400">
