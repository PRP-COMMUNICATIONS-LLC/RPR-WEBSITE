    ...
    <header className="fixed top-0 left-0 right-0 z-[50] h-16 lg:h-20 bg-black/80 backdrop-blur-md border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          {/* GOOGLE BRAND AVATAR (STATION 1) */}
          <button
            className="hidden lg:block w-8 h-8 rounded-md overflow-hidden border border-white/10 hover:border-cyan-500/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.2)] transition-all shrink-0"
            aria-label="Google Identity"
          >
            <img
              src="/assets/web_dark_sq_na@1x.png"
              alt="Google Identity"
